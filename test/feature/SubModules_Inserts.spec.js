...
describe('Sub Modules – Inserts', () => {
  ...
  it('can insert by action via insertOrUpdate', async () => {
    ...
    await store.dispatch('entities/users/insertOrUpdate', { data })
  ...
  it('returns a newly created object when inserting data via insertOrUpdate', async () => {
    ...
    const user = await store.dispatch('entities/users/insertOrUpdate', { data })
  ...
  it('returns many newly created object when inserting multiple data via insertOrUpdate', async () => {
    ...
    const users = await store.dispatch('entities/users/insertOrUpdate', { data })
  ...
  it('can update by action via insertOrUpdate', async () => {
    ...
    await store.dispatch('entities/users/insertOrUpdate', { data: initialData })
