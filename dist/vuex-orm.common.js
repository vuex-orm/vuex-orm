...
var Http = /** @class */ (function () {
    ...
    Http.patch = function (url, data, config) {
        ...
        if (config === void 0) { config = this.defaultConf; }
        this.mergeConf(config);
        return axios$1.patch(url, data, config);
    };
    Http.put = function (url, data, config) {
        if (data === void 0) { data = {}; }
        if (config === void 0) { config = this.defaultConf; }
        this.mergeConf(config);
        return axios$1.put(url, data, config);
    };
    Http.delete = function (url, config) {
        if (config === void 0) { config = this.defaultConf; }
        this.mergeConf(config);
        return axios$1.delete(url, config);
    };
    return Http;
}());
...
var Relation = /** @class */ (function (_super) {
    ...
    Relation.prototype.mapRecords = function (records, key) {
        return records.reduce(function (records, record) {
            var _a;
            return __assign$2({}, records, (_a = {}, _a[record[key]] = record, _a));
        }, {});
    };
    /**
...
var MorphedByMany = /** @class */ (function (_super) {
    ...
    MorphedByMany.prototype.createPivotRecord = function (data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            data[_this.pivot.entity] = __assign$5({}, data[_this.pivot.entity], (_a = {}, _a[pivotKey] = (_b = {
                    $id: pivotKey
...
var ProcessStrategy = /** @class */ (function () {
    ...
    ProcessStrategy.setId = function (record, model, noKey, key) {
        ...
        return __assign$6({}, record, { $id: id !== undefined ? id : noKey.increment(key) });
    };
    /**
    ...
    ProcessStrategy.generateMorphFields = function (record, parentValue, parent, attr) {
        ...
        return __assign$6((_a = {}, _a[attr.id] = parentValue.$id, _a[attr.type] = parent.entity, _a), record);
    };
...
var Schema = /** @class */ (function () {
    ...
    Schema.one = function (model, schemas, parent, attr) {
        ...
        var definition = this.definition(model, __assign$7({}, schemas, (_a = {}, _a[model.entity] = thisSchema, _a)));
...
var IdFixer = /** @class */ (function () {
    ...
    IdFixer.processRecords = function (records, query) {
        return Object.keys(records).reduce(function (newRecords, id) {
            ...
            newRecords[newStringId] = __assign$8({}, record, { $id: newId });
            return newRecords;
        }, {});
    };
    return IdFixer;
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.commit = function (method, payload, callback) {
        ...
        payload = __assign$9({ entity: this.entity }, payload);
    ...
    Query.prototype.commitInsert = function (data) {
        ...
        this.commit('commitInsert', { data: data }, function () {
            _this.state.data = __assign$9({}, _this.state.data, data);
        });
    };
    /**
     * Update data in the state.
    ...
    Query.prototype.find = function (id) {
        ...
        return this.item(__assign$9({}, record));
    };
    /**
    ...
    Query.prototype.records = function (records) {
        ...
        return Object.keys(theRecords).map(function (id) { return (__assign$9({}, theRecords[id])); });
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Http[method](url)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!_conf.remote) return [3 /*break*/, 2];
                        method = _conf.http.method;
                        return [4 /*yield*/, Http[method](this.getUrl(_conf))
                                .catch(function (err) { console.log(err); })];
                    case 1:
                        data = (_a.sent()) || [];
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!_conf.remote) return [3 /*break*/, 2];
                        method = _conf.http.method;
                        return [4 /*yield*/, Http[method](this.getUrl(_conf), data)
                                .catch(function (err) { console.log(err); })];
                    case 1:
                        dataOutput = (_a.sent()) || [];
                        if (_conf.localSync) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = this.getUrl(_conf, new PathParam('id', id.toString()));
                        method = _conf.http.method;
                        return [4 /*yield*/, Http[method](url, data)
                                .catch(function (err) { console.log(err); })];
                    case 1:
                        dataOutput = (_a.sent()) || [];
